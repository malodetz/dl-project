...
class Code2Seq(LightningModule):
    ...
    def _shared_epoch_end(self, step_outputs: STEP_OUTPUT, step: str):
        with torch.no_grad():
    ...
    def training_epoch_end(self, step_outputs: STEP_OUTPUT):
        self._shared_epoch_end(step_outputs, "train")

    def validation_epoch_end(self, step_outputs: STEP_OUTPUT):
        self._shared_epoch_end(step_outputs, "val")

    def test_epoch_end(self, step_outputs: STEP_OUTPUT):
